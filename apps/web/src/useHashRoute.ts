...
export type PortalRoute = "login" | "dashboard" | "drawings" | "customers" | "customer" | "job" | "drawing" | "editor" | "estimate" | "pricing" | "admin";
...
const KNOWN_ROUTES = new Set<PortalRoute>(["login", "dashboard", "drawings", "customers", "customer", "job", "drawing", "editor", "estimate", "pricing", "admin"]);
