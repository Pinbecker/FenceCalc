...
- Monorepo and workspace automation.
- Shared contracts + schemas.
- Geometry utilities and tests.
- Rules engine with deterministic counts.

## Phase 2: Drawing Core

- Segment draw workflow with 5 degree snap.
- Infinite-feel zoom and pan.
